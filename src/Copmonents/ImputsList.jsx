...
export default function ImputsList({user}) {
  const typeOfInputs = {
    new: [
    ...
    login: [
      { name: "Email Address", type: "email", placeholder: "Email Address", errorMessage: "User with this email is not found." },
      { name: "Password", type: "password", placeholder: "Password", errorMessage: "Wrong password." }
    ],
    edit: [
      { name: "Username", type: "text", placeholder: "Username", errorMessage: "Username must be from 4 to 8 letters"},
      { name: "Email Address", type: "email", placeholder: "Email Address", errorMessage: "Invalid email format."},
      { name: "New password", type: "password", placeholder: "New password", errorMessage: "Password must not be same with last"},
      { name: "Avatar image(url)", type: "url", placeholder: "Avatar image", errorMessage: "Invalid URL format."},
    ],
  }
